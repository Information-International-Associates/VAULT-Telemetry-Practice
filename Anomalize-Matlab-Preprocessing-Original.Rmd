...
# Practice Creating a Filename Programatically
```{r}
...
(min_sample_rate <- min(catalog2$field_sampling_rate))
# [1] 0.25
(max_sample_rate <- max(catalog2$field_sampling_rate))
# [1] 16
(min_rows <- min(catalog2$number_rows_middle_file))
# [1] 2103
(max_rows <- max(catalog2$number_rows_middle_file))
# [1] 134592
